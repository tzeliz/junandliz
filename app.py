    ...
    with open('names.csv', newline='') as csvfile:
        ...
        for row in reader:
            guests[row['code']] = {
                ...
                'no_date': row.get('no_date', 'no').lower()  # default to 'no'
            }
    return guests
...
def invitation():
    ...
    last_minute = guest['last_minute']
    last_minute2 = guest['last_minute2']
    no_date = guest['no_date']
